...
export default function Dashboard({ onLogout }: DashboardProps) {
    ...
    const [activeTab, setActiveTab] = useState<'home' | 'transactions' | 'attendance' | 'shifts' | 'push' | 'admin' | 'orders'>('home');
    ...
    useEffect(() => {
        ...
        if (pathname === '/transactions') setActiveTab('transactions');
        else if (pathname === '/attendance') setActiveTab('attendance');
        else if (pathname === '/shifts') setActiveTab('shifts');
        else if (pathname === '/push') setActiveTab('push');
            ...
            <div className={`fixed inset-y-0 left-0 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out z-50 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:z-10`}>
                ...
                <nav className="p-4">
                    <ul className="space-y-2">
                        <li>
                            <button
                                onClick={() => { setActiveTab('home'); setSidebarOpen(false); router.push('/'); }}
                        ...
                        <li>
                            <button
                                onClick={() => { setActiveTab('transactions'); setSidebarOpen(false); router.push('/transactions'); }}
                        ...
                        <li>
                            <button
                                onClick={() => { setActiveTab('attendance'); setSidebarOpen(false); router.push('/attendance'); }}
                        ...
                        <li>
                            <button
                                onClick={() => { setActiveTab('shifts'); setSidebarOpen(false); router.push('/shifts'); }}
                        ...
                        {userRole === 'admin' && (
                            <li>
                                <button
                                    onClick={() => { setActiveTab('admin'); setSidebarOpen(false); router.push('/admin'); }}
                        ...
                        {userRole !== 'admin' && (
                            <li>
                                <button
                                    onClick={() => { setActiveTab('push'); setSidebarOpen(false); router.push('/push'); }}
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-2">
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <select
                                                ...
                                                className="block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white hover:border-gray-400 transition-colors duration-200"
                                            >
